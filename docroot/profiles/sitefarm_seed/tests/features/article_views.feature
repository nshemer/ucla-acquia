Feature: A User should see lists of articles
  ...
  Background:
    Given I am an anonymous user
      ...
      And "sf_article" content:
        | title          | field_sf_article_category | field_sf_tags | field_sf_article_type | created           |
        | First Article  | Views Category            | Views Tag     | News                  | 2019-10-17 8:00am |
        | Second Article | Views Cat 2               | Views Tag     | News                  | 2019-10-17 9:00am |
        | Third Article  | Views Category            | Views Tag 2   | News                  | 2019-10-17 10:00am |
        | Fourth Article | Views Category            | Views Tag 2   | Views Type            | 2019-10-17 11:00am |
        | First Blog     | Views Category            | Views Tag     | Blog                  | 2019-10-17 12:00pm |
        | Second Blog    | Views Cat 2               | Views Tag     | Blog                  | 2019-10-17 1:00pm |
        | Third Blog     | Views Category            | Views Tag 2   | Blog                  | 2019-10-17 2:00pm |
  ...
  Scenario: Recent articles showing on the home page
    ...
    Then I should see "First Blog" in the "Sidebar First Region"
      And I should see "Second Blog" in the "Sidebar First Region"
      And I should see "Third Blog" in the "Sidebar First Region"
